...
const Experiencia: FC<ExperienciaProps> = ({ slice }) => {
  ...
  return (
    <section
      ...
      className="bg-white dark:bg-night-dark pt-12 pb-2 md:py-20 relative overflow-hidden transition-colors duration-300"
    >
      ...
      <div className="relative w-full overflow-hidden bg-white dark:bg-night-dark before:absolute before:left-0 before:top-0 before:w-16 md:before:w-32 before:h-full before:bg-gradient-to-r before:from-white dark:before:from-night-dark before:to-transparent before:z-10 after:absolute after:right-0 after:top-0 after:w-16 md:after:w-32 after:h-full after:bg-gradient-to-l after:from-white dark:after:from-night-dark after:to-transparent after:z-10 transition-colors duration-300">
