...
export default async function Footer() {
  ...
  function getIcon(nombre: KeyTextField) {
    switch (nombre) {
      case "facebook":
        return (
          <SocialIcon platform="facebook" className="w-8 h-8 object-contain" />
        );
      case "instagram":
        return (
          <SocialIcon platform="instagram" className="w-8 h-8 object-contain" />
        );
      case "linkedin":
        return (
          <SocialIcon platform="linkedin" className="w-8 h-8 object-contain" />
        );
      default:
        return null;
    }
