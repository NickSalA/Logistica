        ...
        <div className="section-container flex items-center justify-between">
          ...
          <ul className="hidden md:flex items-center gap-2 lg:gap-3 font-primary">
            {settings.data.nav.map((item, index) => {
                    ...
                    >
                      ...
                      <ChevronDown
                        className={clsx(
                          ...
                          isSolid
                            ? "text-gray-500 group-hover:text-night dark:group-hover:text-white"
                        ...
                        <div className="flex flex-col gap-1">
                          {serviciosMenu.map((sub, idx) => {
                            ...
                            return (
                              ...
                              >
                                <div className="w-9 h-9 rounded-xl bg-gray-100 dark:bg-white/5 flex items-center justify-center text-night dark:text-white shrink-0 group-hover/sub:bg-accent group-hover/sub:text-night transition-colors">
              ...
              return (
                <li key={item.label}>
                  <PrismicNextLink field={item.link} className={linkClasses}>
                    {item.label}
                  </PrismicNextLink>
                </li>
              );
          ...
          {settings.data.nav.map((item, index) => {
            ...
            if (item.special) {
              return (
                <div
                  key={item.label}
                  className="flex flex-col w-full bg-gray-50/80 dark:bg-white/5 rounded-2xl p-3 border border-gray-100 dark:border-white/10"
                >
                  <button
                    type="button"
                    ...
                    <div className="flex flex-col gap-2 mt-3 pt-2 border-t border-gray-200/60 dark:border-white/10">
                      {serviciosMenu.map((sub, idx) => {
                        ...
                        return (
                          ...
                          >
                            <div className="w-8 h-8 rounded-lg bg-accent/20 flex items-center justify-center text-night dark:text-white shrink-0">
                              <SubIcon className="w-4 h-4" />
                            </div>
